import { bindControls } from "./ui/input.js?v=mvp111-discard-center-1";
import { renderGame } from "./ui/render.js?v=mvp111-discard-center-1";

const APP_ASSET_VERSION = "mvp111-discard-center-1";
