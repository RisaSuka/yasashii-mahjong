import { bindControls } from "./ui/input.js?v=mvp112-discard-fix-1";
import { renderGame } from "./ui/render.js?v=mvp112-discard-fix-1";

const APP_ASSET_VERSION = "mvp112-discard-fix-1";
