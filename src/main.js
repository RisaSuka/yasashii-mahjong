import { bindControls } from "./ui/input.js?v=mvp201-svg-tiles-redesign-1";
import { renderGame } from "./ui/render.js?v=mvp201-svg-tiles-redesign-1";

const APP_ASSET_VERSION = "mvp201-svg-tiles-redesign-1";
