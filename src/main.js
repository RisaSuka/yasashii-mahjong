import { bindControls } from "./ui/input.js?v=mvp345-assist-buttons-hitfix-1";
import { renderGame } from "./ui/render.js?v=mvp345-assist-buttons-hitfix-1";

const APP_ASSET_VERSION = "mvp345-assist-buttons-hitfix-1";
