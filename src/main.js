import { bindControls } from "./ui/input.js?v=mvp341-exact-layout-redo-1";
import { renderGame } from "./ui/render.js?v=mvp341-exact-layout-redo-1";

const APP_ASSET_VERSION = "mvp341-exact-layout-redo-1";
