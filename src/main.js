import { bindControls } from "./ui/input.js?v=mvp191-all-hands-sorted-1";
import { renderGame } from "./ui/render.js?v=mvp191-all-hands-sorted-1";

const APP_ASSET_VERSION = "mvp191-all-hands-sorted-1";
