import { bindControls } from "./ui/input.js?v=mvp113-discard-stable-1";
import { renderGame } from "./ui/render.js?v=mvp113-discard-stable-1";

const APP_ASSET_VERSION = "mvp113-discard-stable-1";
