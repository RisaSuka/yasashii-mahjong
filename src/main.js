import { bindControls } from "./ui/input.js?v=mvp20-svg-tiles-1";
import { renderGame } from "./ui/render.js?v=mvp20-svg-tiles-1";

const APP_ASSET_VERSION = "mvp20-svg-tiles-1";
